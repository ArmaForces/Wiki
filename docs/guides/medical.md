...
![Menu medyczne](../_data/guides/medical/medical_menu.png)

- **Logi aktywności** – Informacje o wykonanych czynnościach np.założenie stazy, zabandażowanie rany, przetoczenie krwi itp.z podaną godziną. 
- **Szybki podgląd** – Wyniki pomiarów ciśnienia krwi oraz tętna wraz z podaną godziną.
- **Opis** – Kończyna,ilość utraconej krwi przez organizm, stopień odczuwanego bólu, wykaz ran na danej kończynie lub torsie.
- **Status** – Graficzny status organizmu. Im barwa danej kończyny jest bardziej czerwona, tym większe poniosła obrażenia. Niebieski kolor oznacza stłuczenie(nie da się usunąć, ale nie wpływa z znaczący sposób na organizm). Niebieskie paski oznaczają założoną stazę na danej kończynie. Możemy kolejno sprawdzać, opatrywać, podawać środki pierwszej pomocy na daną kończynę/tors poprzez kliknięcie na dany fragment na obrazku.
- **Badanie i leczenie** – W tych zakładkach umieszczone są wszystkie akcje związane z czynnościami pierwszej pomocy. Poniżej przedstawiono opis każdej zakładki, zaczynając od skrajnej lewej.
...
Podczas rozgrywki krew jest jednym z najcenniejszych zapasów. Z tego powodu, w miarę możliwości trzymaj przy sobie krew i uzupełniaj jej zapas, jeżeli jest taka możliwość. 0,5 - 1,0 l w zupełności wystarczy, gdybyś stracił przytomność oraz znacząco odciążysz medyka. Jeżeli jesteś przytomny, nie potrzebujesz przetoczenia krwi do momentu pojawienia się szarego ekranu.

## Środki przeciwbólowe

### APAP

W razie wystąpienia bólu, zażyj APAP. Jeżeli siła bólu jest duża,zażyj 2 tabletki APAP. Praktycznie nie powoduje on objawów ubocznych (chyba że zażyjesz 10 tabletek w bardzo krótkim czasie). Jego opóźnienie w działaniu jest dłuższe, a czas działania krótszy niż morfina, aczkolwiek siła tłumienia bólu jest niewiele mniejsza od morfiny.
...
![Triaż - przydzielanie](../_data/guides/medical/triange.png)

## Krew, osocze, sól fizjologiczna

W Medicalu każdy żołnierz ma 6 litrów krwi z organizmie. Każdy próg ma przypisany przedział ilości krwi występującej w danej chwili w organizmie żołnierza. Występują cztery progi:
