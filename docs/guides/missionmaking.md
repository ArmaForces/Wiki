...
W naszych misjach pojawiają się różne treści. Takie rzeczy można przygotowywać w pliku stringtable.xml. Misja pokazaowa ma tam zdefiniowaną nazwę nazwę misji oraz treść intelu. Najprościej przyjąć że to tablica stałych tekstowych.
